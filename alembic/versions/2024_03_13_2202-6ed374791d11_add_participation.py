...
from app.db.orm import ParticipationStatusAppORM, TransportTypeAppORM
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["direction_id"],
            ["direction.notion_id"],
            name=op.f("fk_participation_direction_id_direction"),
        ),
        sa.ForeignKeyConstraint(
            ["participation_code"],
            ["participation_type.code"],
            name=op.f("fk_participation_participation_code_participation_type"),
        ),
        sa.ForeignKeyConstraint(
            ["person_id"],
            ["person.notion_id"],
            name=op.f("fk_participation_person_id_person"),
        ),
        sa.ForeignKeyConstraint(
            ["role_code"],
            ["participation_role.code"],
            name=op.f("fk_participation_role_code_participation_role"),
        ),
        sa.ForeignKeyConstraint(
            ["status_code"],
            ["participation_status.code"],
            name=op.f("fk_participation_status_code_participation_status"),
        ),
    ...
    op.create_table(
        ...
        sa.Column("comment", sa.String(), nullable=True),
        sa.ForeignKeyConstraint(
            ["badge_id"], ["badge.notion_id"], name=op.f("fk_arrival_badge_id_badge")
        ),
